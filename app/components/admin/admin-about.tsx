...
export default function AdminAbout({ data, setData }) {
	...
	return (
		<Glass className="p-9">
			<h3 className="font-syne font-bold text-white text-xl mb-7">
				Edit About
			</h3>
			...
			<div className="mb-7">
				<label className="block font-mono text-xs uppercase tracking-widest mb-3 text-purple-400">
					Skills
				</label>
			...
			<button
				onClick={save}
				className="btn-primary font-mono text-xs uppercase tracking-widest text-white rounded-xl px-8 py-3"
