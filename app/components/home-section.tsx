      ...
      pb-16 sm:pb-20 overflow-hidden"
          ...
          px-3 sm:px-5 py-1 mb-5 sm:mb-7 md:mb-9 relative overflow-hidden"
					...
					<motion.h1
						...
						style={{
							fontSize: "clamp(35px,10vw,110px)",
							lineHeight: 0.95,
        ...
        text-xs sm:text-sm md:text-base"
            ...
            rounded-xl px-6 sm:px-8 md:px-9 py-3 sm:py-3.5 w-1/2 sm:w-auto relative group"
					...
					<motion.div
						className="flex items-center mt-6  rounded-2xl relative"
						style={{
								...
								>
									...
									>
										<img
											src={social.iconPath}
											alt={social.label}
											className="w-[55px] h-[55px] object-contain ml-1.5 mt-1.5 transition-all duration-300"
										/>
					...
					<motion.div
						className="flex items-center gap-2 sm:gap-4 mt-12"
